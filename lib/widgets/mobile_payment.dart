...
class MobilePayment extends StatefulWidget {
  ...
  const MobilePayment({Key? key, required this.amount}) : super(key: key);
...
class PayBlockModel {
  ...
  PayBlockModel({required this.value, required this.brandImageUrl, this.id});
}
...
class MobilePaymentState extends State<MobilePayment> {
  ...
  List<PayBlockModel> blocksList = [
    PayBlockModel(value: "blik", brandImageUrl: "https://static.payu.com/images/mobile/logos/pbl_blik.png"),
    PayBlockModel(value: "c", brandImageUrl: "https://static.payu.com/images/mobile/logos/pbl_c.png"),
    PayBlockModel(value: "add_card", brandImageUrl: "https://static.payu.com/images/mobile/logos/pbl_c.png")
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisAlignment: MainAxisAlignment.start, children: [
      Container(padding: const EdgeInsets.all(5), child: const Text("Wybierz metodę płatności", style: TextStyle(color: Colors.black, fontSize: 20))),
      SizedBox(
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => TokenPaymentScreen(
                                            cardToken: provider.cardTokens[blocksList[index].id!],
  ...
  Future<int?> _pageSetup() async {
    ...
    for (int i = 0; i < provider.cardTokens.length; i++) {
      blocksList.add(PayBlockModel(value: "card", brandImageUrl: provider.cardTokens[i].brandImageUrl, id: i));
    }
