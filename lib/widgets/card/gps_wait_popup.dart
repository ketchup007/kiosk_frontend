...
class GpsWaitPopup extends StatefulWidget {
  ...
  const GpsWaitPopup({Key? key, required this.onPress}) : super(key: key);
                  ...
                  return Column(
                    children: [
                      Container(
                          ...
                          child: const Text("Wybierz punkt sprzedaży", style: TextStyle(fontSize: 20, fontFamily: "GloryBold"))),
                      SizedBox(
                                        ...
                                        if (distance < 10 && distance > 0) {
                                          ...
                                          return Container(
                                            ...
                                            child: SizedBox(
                                                ...
                                                child: const Text(
                                                  "Jesteś za daleko kontenera, podejdź bliżej albo wybierz inny kontener ",
