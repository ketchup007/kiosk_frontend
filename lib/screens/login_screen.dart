            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Text("Aby się zalogować podaj numer telefonu",
                    style: TextStyle(
                      fontSize: 21,
                      fontFamily: "GloryBold"))),
                const Text("na podany nr zostanie wysłany kod potrzebny do zalogowania",
                          ...
                          return DropdownMenuItem(
                            ...
                            child: Container(
                              ...
                              child: SizedBox(
                                ...
                                child: Text("${value.countryCode.toUpperCase().replaceAllMapped(RegExp(r'[A-Z]'), (match) => String.fromCharCode(match.group(0)!.codeUnitAt(0) + 127397))} ${value.dialCode}",
                                  maxLines: 1,
                                  style: TextStyle(
