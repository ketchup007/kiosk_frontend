                    ...
                    Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                          Container(
                              ...
                              child: LanguageButtons(ribbonHeight: MediaQuery.of(context).size.height * 0.05, ribbonWidth: MediaQuery.of(context).size.width * 0.05)),
                          Container(
                              padding: EdgeInsets.fromLTRB(0, MediaQuery.of(context).size.height * 0.015, MediaQuery.of(context).size.width * 0.05, 0),
                              width: MediaQuery.of(context).size.width * 0.2,
                              child: const FittedBox(child: Text("Menu", style: TextStyle(fontSize: 60, fontFamily: 'GloryMedium'))))
                        ]))
                  ]),
//------------------------------------------------------------------------------
//Sekcja Przycisków
