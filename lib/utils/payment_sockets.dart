...
class Payment {
  ...
  Future<String> startPayment(double price) async {
    ...
    List<int> tagEftMessageNumberFull = tagEftMessageNumber +
        tagEftMessageNumberLength +
        tagEftMessageNumberValue;
    ...
    List<int> tagEftAmount1Full =
        tagEftAmount1 + tagEftAmount1Length + tagEftAmount1Value;

    List<int> tagEftAmount1Label = [0x05, 0x00, 0x02, 0x00];
    List<int> tagEftAmount1LabelLength = [0x07, 0x00, 0x00, 0x00]; //7
    List<int> tagEftAmount1LabelValue = [
      0x41,
      0x6D,
      0x6F,
      0x75,
    ...
    List<int> tagEftAmount1LabelFull =
        tagEftAmount1Label + tagEftAmount1LabelLength + tagEftAmount1LabelValue;
    ...
    List<int> tagEftTransactionTypeFull = tagEftTransactionType +
        tagEftTransactionTypeLength +
        tagEftTransactionTypeValue;

    List<int> tagEftAmount2 = [0x02, 0x00, 0x02, 0x00];
    List<int> tagEftAmount2Length = [0x0C, 0x00, 0x00, 0x00]; // 7
    List<int> tagEftAmount2Value = [
      0x30,
      0x30,
      0x30,
      0x30,
    ...
    List<int> tagEftAmount2Full =
        tagEftAmount2 + tagEftAmount2Length + tagEftAmount2Value;

    List<int> tagEftAmount3 = [0x03, 0x00, 0x02, 0x00];
    List<int> tagEftAmount3Length = [0x0C, 0x00, 0x00, 0x00]; // 12
    List<int> tagEftAmount3Value = [
      0x30,
      0x30,
      0x30,
      0x30,
    ...
    List<int> tagEftAmount3Full =
        tagEftAmount3 + tagEftAmount3Length + tagEftAmount3Value;

    List<int> tagEftAmount4 = [0x04, 0x00, 0x02, 0x00];
    List<int> tagEftAmount4Length = [0x0C, 0x00, 0x00, 0x00]; // 12
    List<int> tagEftAmount4Value = [
      0x30,
      0x30,
      0x30,
      0x30,
    ...
    List<int> tagEftAmount4Full =
        tagEftAmount4 + tagEftAmount4Length + tagEftAmount4Value;

    List<int> tagEftAmount2Label = [0x06, 0x00, 0x02, 0x00];
    List<int> tagEftAmount2LabelLength = [0x07, 0x00, 0x00, 0x00]; // 7
    List<int> tagEftAmount2LabelValue = [
      0x41,
      0x6D,
      0x6F,
      0x75,
    ...
    List<int> tagEftAmount2LabelFull =
        tagEftAmount2Label + tagEftAmount2LabelLength + tagEftAmount2LabelValue;

    List<int> tagEftAmount3Label = [0x07, 0x00, 0x02, 0x00];
    List<int> tagEftAmount3LabelLength = [0x07, 0x00, 0x00, 0x00]; // 7
    List<int> tagEftAmount3LabelValue = [
      0x41,
      0x6D,
      0x6F,
      0x75,
    ...
    List<int> tagEftAmount3LabelFull =
        tagEftAmount3Label + tagEftAmount3LabelLength + tagEftAmount3LabelValue;

    List<int> tagEftAmount4Label = [0x08, 0x00, 0x02, 0x00];
    List<int> tagEftAmount4LabelLength = [0x07, 0x00, 0x00, 0x00]; // 7
    List<int> tagEftAmount4LabelValue = [
      0x41,
      0x6D,
      0x6F,
      0x75,
    ...
    List<int> tagEftAmount4LabelFull =
        tagEftAmount4Label + tagEftAmount4LabelLength + tagEftAmount4LabelValue;
    ...
    List<int> tagEftCommercialCodeFull = tagEftCommercialCode +
        tagEftCommercialCodeLength +
        tagEftCommercialCodeValue;
    ...
    List<int> tagEftSuspectFraudIndicatorFull = tagEftSuspectFraudIndicator +
        tagEftSuspectFraudIndicatorLength +
        tagEftSuspectFraudIndicatorValue;
    ...
    List<int> tagEftReturnCardRespValueFull = tagEftReturnCardRespValue +
        tagEftReturnCardRespValueLength +
        tagEftReturnCardRespValueValue;
    ...
    List<int> tagEftReturnSigReqValueFull = tagEftReturnSigReqValue +
        tagEftReturnSigReqValueLength +
        tagEftReturnSigReqValueValue;
    ...
    List<int> tagEftEnableEcrBlikFull = tagEftEnableEcrBlik +
        tagEftEnableEcrBlikLength +
        tagEftEnableEcrBlikValue;
    ...
    List<int> tagEftEnableTokenFull =
        tagEftEnableToken + tagEftEnableTokenLength + tagEftEnableTokenValue;

    List<int> tagEftEnableReturnMarkupTextIndicator = [0x9B, 0x00, 0x02, 0x00];
    List<int> tagEftEnableReturnMarkupTextIndicatorLength = [
      0x01,
      0x00,
      0x00,
      0x00
    ...
    List<int> tagEftEnableReturnMarkupTextIndicatorFull =
    ...
    List<int> tagEftReturnApmDataFull = tagEftReturnApmData +
        tagEftReturnApmDataLength +
        tagEftReturnApmDataValue;
